...
<html lang="en">
                        ...
                        <tbody>
                            @foreach($clientes as $cliente)
                                <tr>
                                    ...
                                    <td class="px-6 py-3">{{ $cliente->apellido }}</td>
                                    <td class="px-6 py-3">{{ $cliente->cedula }}</td>
                                    <td class="px-6 py-3">{{ $cliente->correo }}</td>
                                    <td class="px-6 py-3 text-center">
                                        <!-- Botón Editar -->
                                        <a href="{{ route('clientes.edit', $cliente->id) }}" class="text-blue-600 hover:text-blue-800 mr-2" title="Editar">
                                        ...
                                        <form action="{{ route('clientes.destroy', $cliente->id) }}" method="POST" style="display:inline-block;">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" onclick="return confirm('¿Seguro que deseas eliminar este cliente?')" class="text-red-600 hover:text-red-800" title="Eliminar">
    ...
    <div class="modal fade" id="importModal" tabindex="-1" aria-labelledby="importModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <h5 class="modal-title" id="importModalLabel">Crear nuevo cliente</h5>
                ...
                <div class="modal-body">
                    <form action="{{ route('clientes.store') }}" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-floating mb-3">
                                    <input type="text" name="cedula" class="form-control" id="inputClave" placeholder="Cedula" required>
                                    <label for="inputClave">Cedula</label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-floating mb-3">
                                    <input type="text" name="apellido" class="form-control" id="inputLastName" placeholder="Apellido" required>
  ...
  <script src="{{ asset('js/perfect-scrollbar.js') }}" defer></script>
    ...
    <script src="{{ asset('js/navbar-collapse.js') }}" defer></script>
    <script src="{{ asset('js/tooltips.js') }}" defer></script>
    <script src="{{ asset('js/nav-pills.js') }}" defer></script>
    <script src="{{ asset('js/dropdown.js') }}" defer></script>
    <script src="{{ asset('js/fixed-plugin.js') }}" defer></script>
    <script src="{{ asset('js/navbar-sticky.js') }}" defer></script>
    <script src="{{ asset('js/sidenav-burger.js') }}" defer></script>
